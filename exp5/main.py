...
def sound_rec(t):
    ...
    RECORD_SECONDS = t
    # 要写入的文件名
    WAVE_OUTPUT_FILENAME = "C:\\Users\\young\\Desktop\\output.wav"
    # 创建PyAudio对象
    p = pyaudio.PyAudio()
    # 打开数据流
...
sound_rec(6)
wave,frames,nframes=wave_read("C:\\Users\\young\\Desktop\\output.wav")
#wave,frames,nframes=wave_read(r"C:\Windows\Media\Ding.wav")
